...
@testset "knuth_matroid_construction_v4" begin
  # The example from Knuth (1974) section 3.
  n = 10
  enlargements = [nothing, [0x1a, 0x222, 0x64, 0x128, 0x288, 0x10c]]
  ...
  @test knuth_matroid_construction_v4(n, enlargements) == (n, F)
end

@testset "knuth_matroid_construction_v5" begin
  # The example from Knuth (1974) section 3.
  n = 10
  enlargements = [nothing, [0x1a, 0x222, 0x64, 0x128, 0x288, 0x10c]]
  ...
  _, result = knuth_matroid_construction_v5(n, enlargements)
...
@testset "knuth_matroid_construction_v6" begin
  # The example from Knuth (1974) section 3.
  n = 10
  enlargements = [nothing, [0x1a, 0x222, 0x64, 0x128, 0x288, 0x10c]]
  ...
  # println([bits_to_set(b) for b in setdiff(result[3], F2)])
  # println([bits_to_set(b) for b in setdiff(F2, result[3])])
